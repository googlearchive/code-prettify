  ...
  <body bgcolor="white">
    ...
    <ul>
      <li>Added <a href="tests/prettify_test.html#PHP">tests</a> for PHP support
        to address
      <a href="https://github.com/google/code-prettify/issues/3"
       >issue 3</a>.
      <li>Fixed
      <a href="https://github.com/google/code-prettify/issues/6"
       >bug</a>: <code>prettyPrintOne</code> was not halting.  This was not
        reachable through the normal entry point.
      <li>Fixed
      <a href="https://github.com/google/code-prettify/issues/4"
       >bug</a>: recursing into a script block or PHP tag that was not properly
        closed would not silently drop the content.
        (<a href="tests/prettify_test.html#issue4">test</a>)
      <li>Fixed
      <a href="https://github.com/google/code-prettify/issues/8"
      ...
      <a href="https://github.com/google/code-prettify/issues/4"
       >patch</a>
      <li>Added a small distribution that has comments and
        whitespace removed to reduce download size from 45.5kB to 12.8kB.
    </ul>
    <h2>4 Jul 2008</h2>
    <ul>
      <li>Added <a href="https://github.com/google/code-prettify/issues/17">language specific formatters</a> that are triggered by the presence
      of a <code>lang-&lt;language-file-extension&gt;</code></li>
      <li>Fixed <a href="https://github.com/google/code-prettify/issues/29">bug</a>: python handling of <code>'''string'''</code>
    ...
    <ul>
      ...
      <li>Added <tt>.mxml</tt> extension to the markup style handler for
        ...
        <a
        href="https://github.com/google/code-prettify/issues/37"
        >issue 37</a>.
      <li>Added <tt>.m</tt> extension to the C style handler so that Objective
        C source files properly highlight.  See
        <a
        href="https://github.com/google/code-prettify/issues/58"
       >issue 58</a>.
    ...
    <ul>
      <li>Added support for line numbers.  Bug
        <a href="https://github.com/google/code-prettify/issues/22"
         >22</a></li>
      <li>Added YAML support.  Bug
        <a href="https://github.com/google/code-prettify/issues/123"
         >123</a></li>
      <li>Added VHDL support courtesy Le Poussin.</li>
      <li>IE performance improvements.  Bug
        <a href="https://github.com/google/code-prettify/issues/102"
      ...
      <li>Changed output to use <code>&amp;#160;</code> instead of
        ...
        Bug
        <a href="https://github.com/google/code-prettify/issues/108"
         >108</a>.</li>
    </ul>
    ...
    <h2>4 March 2011</h2>
    <ul>
      <li>Added a <a href="styles/index.html">themes
