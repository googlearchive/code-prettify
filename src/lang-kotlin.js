...
PR['registerLangHandler'](
    PR['createSimpleLexer'](
        ...
        [
            // keywords
            [PR['PR_KEYWORD'],
                /^\b(\$|package|import|for|while|as|typealias|get|set|((data|enum) )?class|this|super|val|var|fun|is|in|throw|return|break|continue|(companion )?object|if|try|else|do|when|init|interface|typeof)\b/],
